...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">R</span> <span class="o">=</span> <span class="n">PolynomialRing</span><span class="p">(</span><span class="n">QQ</span><span class="p">,</span> <span class="p">[</span><span class="s1">&#39;a11&#39;</span><span class="p">,</span> <span class="s1">&#39;a12&#39;</span><span class="p">,</span> <span class="s1">&#39;a13&#39;</span><span class="p">,</span> <span class="s1">&#39;a21&#39;</span><span class="p">,</span> <span class="s1">&#39;a22&#39;</span><span class="p">,</span> <span class="s1">&#39;a23&#39;</span><span class="p">,</span> <span class="s1">&#39;a31&#39;</span><span class="p">,</span> <span class="s1">&#39;a32&#39;</span><span class="p">,</span> <span class="s1">&#39;a33&#39;</span><span class="p">,</span> <span class="s1">&#39;x1&#39;</span><span class="p">,</span> <span class="s1">&#39;x2&#39;</span><span class="p">])</span>
<span class="n">R</span><span class="o">.</span><span class="n">inject_variables</span><span class="p">()</span>
</pre></div>
...
<pre>Defining a11, a12, a13, a21, a22, a23, a31, a32, a33, x1, x2
</pre>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">p1</span> <span class="o">=</span> <span class="n">a11</span><span class="o">*</span><span class="n">x1</span> <span class="o">+</span> <span class="n">a12</span><span class="o">*</span><span class="n">x2</span> <span class="o">+</span> <span class="n">a13</span>
<span class="n">p2</span> <span class="o">=</span> <span class="n">a21</span><span class="o">*</span><span class="n">x1</span> <span class="o">+</span> <span class="n">a22</span><span class="o">*</span><span class="n">x2</span> <span class="o">+</span> <span class="n">a23</span>
<span class="n">p3</span> <span class="o">=</span> <span class="n">a31</span><span class="o">*</span><span class="n">x1</span> <span class="o">+</span> <span class="n">a32</span><span class="o">*</span><span class="n">x2</span> <span class="o">+</span> <span class="n">a33</span>
<span class="n">EI</span> <span class="o">=</span> <span class="n">ideal</span><span class="p">(</span><span class="n">p1</span><span class="p">,</span> <span class="n">p2</span><span class="p">,</span> <span class="n">p3</span><span class="p">)</span><span class="o">.</span><span class="n">elimination_ideal</span><span class="p">([</span><span class="n">x1</span><span class="p">,</span> <span class="n">x2</span><span class="p">])</span>
<span class="n">resultant</span> <span class="o">=</span> <span class="n">EI</span><span class="o">.</span><span class="n">gens</span><span class="p">()[</span><span class="mi">0</span><span class="p">]</span>
<span class="n">resultant</span>
</pre></div>
...
<pre>a13*a22*a31 - a12*a23*a31 - a13*a21*a32 + a11*a23*a32 + a12*a21*a33 - a11*a22*a33</pre>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">resultant</span><span class="o">.</span><span class="n">newton_polytope</span><span class="p">()</span>
</pre></div>
...
<div class="output_text output_subarea output_execute_result">
<pre>A 4-dimensional polyhedron in ZZ^11 defined as the convex hull of 6 vertices (use the .plot() method to plot)</pre>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">resultant</span><span class="o">.</span><span class="n">newton_polytope</span><span class="p">()</span><span class="o">.</span><span class="n">plot</span><span class="p">()</span>
</pre></div>
